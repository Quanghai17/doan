<footer id="rs-footer" class="rs-footer">
                ...
                <div class="col-lg-3 col-md-12 col-sm-12 md-mb-30">
                    ...
                    <ul class="address-widget">
                        ...
                        <li>
                            ...
                            <div class="desc">
                               <a href="tel:(+880)155-69569">(+84){{setting('admin.phone')}}</a>
                            </div>
                        </li>
                        <li>
                            <i class="flaticon-email"></i>
                            <div class="desc">
                                <a href="mailto:support@rstheme.com">{{setting('admin.email')}}</a>
                            </div>
                        </li>
                        <li>
    ...
    <div class="footer-bottom">
        <div class="container">                    
            <div style="text-align: center"  class="row y-middle">
                    <div class="copyright">
                        <p>&copy; 2021 All Rights Reserved. Developed By <a href="#">Nguyen Quang Linh</a></p>
                    </div>
            </div>
        </div>
    </div>
